...
class Compunnel_Prediction_Adminhtml_Prediction_Whitelist_HomepageController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initRule()
    {
        ...
        $rule = Mage::getModel('prediction/whitelist_rule');
        ...
        Mage::register('current_prediction_whitelist_homepage_rule', $rule);
        return $rule;
    }
    ...
    public function relatedAction()
    {
        $this->_initRule();
        $this->loadLayout();
        $this->getLayout()->getBlock('prediction.whitelist.homepage.edit.tab.products')->setProducts($this->getRequest()->getPost('products_related', null));
        $this->renderLayout();
    }
    ...
    public function saveAction()
    {
        if ($this->getRequest()->getPost()) {
            try {
                $model = Mage::getModel('prediction/whitelist_rule');
                Mage::dispatchEvent('adminhtml_controller_prediction_whitelist_rule_prepare_save', array('request' => $this->getRequest()));
