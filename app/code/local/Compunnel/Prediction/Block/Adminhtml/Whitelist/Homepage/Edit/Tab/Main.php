 ...
 */
class Compunnel_Prediction_Block_Adminhtml_Whitelist_Homepage_Edit_Tab_Main extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        $model = Mage::registry('current_prediction_whitelist_homepage_rule');
        ...
        $this->setForm($form);
        Mage::dispatchEvent('adminhtml_prediction_whitelist_homepage_edit_main_prepare_form', array('form' => $form));
        return parent::_prepareForm();
    }

    protected function _isAllowedAction($action)
    {
        return Mage::getSingleton('admin/session')->isAllowed('prediction/whitelist/whitelist_homepage/' . $action);
    }
