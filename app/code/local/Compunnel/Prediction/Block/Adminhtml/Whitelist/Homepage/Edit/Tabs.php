 ...
 */
class Compunnel_Prediction_Block_Adminhtml_Whitelist_Homepage_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('adminhtml_whitelist_homepage_tabs');
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main', array(
            ...
            'content'   => $this->getLayout()->createBlock('prediction/adminhtml_whitelist_homepage_edit_tab_main')->toHtml(),
            'active'    => true
            ));
