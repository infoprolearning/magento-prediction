 ...
 */
class Compunnel_Prediction_Block_Adminhtml_Whitelist_Homepage_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return Mage::registry('current_prediction_whitelist_homepage_rule');
    }
    ...
    public function getSelectedProducts()
    {
        ...
        return Mage::getModel('prediction/whitelist_rule_product')->getProductsByRuleId($ruleId);
    }
