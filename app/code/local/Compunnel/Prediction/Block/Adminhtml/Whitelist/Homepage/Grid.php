<?php
class Compunnel_Prediction_Block_Adminhtml_Whitelist_Homepage_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('prediction/whitelist_rule')->getResourceCollection();
