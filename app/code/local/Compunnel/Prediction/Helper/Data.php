    ...
    class Compunnel_Prediction_Helper_Data extends Compunnel_Prediction_Helper_Abstract
    {
        ...
        public function postEventData($data, $storeId)
        {
            ...
            try {
                ...
                $curlObject->write(Zend_Http_Client::POST, $this->getEventUrl($storeId), '1.1', $headers, json_encode($data));
                $result = $curlObject->read();
                $curlObject->close();
                return $result;
            }
        ...
        {
            return $this->getEngineUrl($storeId) . ':' . self::EVENT_PORT . '/queries.json';
        }
